...
export const VibeSignInScreen: React.FC = () => {
    ...
    <View style={styles.container}>
      <View style={styles.content}>
        ...
        <View style={styles.logoSection}>
          ...
          <Text style={styles.title}>vibecoder</Text>
        </View>
        ...
        <Text style={styles.infoText}>
          Don't have an account? Sign up at vibecoder.com
        </Text>
      </View>
    </View>
  );
...
export default VibeSignInScreen;
